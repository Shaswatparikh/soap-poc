...
@WebServiceClient(name = "Weather", 
                  wsdlLocation = "file:/home/user/testproject/weather-client/src/main/wsdl/weather.wsdl",
...
public class Weather extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/user/testproject/weather-client/src/main/wsdl/weather.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/home/user/testproject/weather-client/src/main/wsdl/weather.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
